...
\Authors{Jens Buysse\textsuperscript{1}*, Anita Bernard\textsuperscript{1}, Bert Van Vreckem\textsuperscript{1}} % Authors
...
\affiliation{*\textbf{Contact}: jens.buysse@hogent.be} % Corresponding author
